...
\SetupTable
\end{center}
\takeaway{The same detector, evaluation rule are used for the main comparisons.}
\end{frame}
...
\end{center}
\vspace{-0.15em}
\begin{center}\small F1 rises from about 0.71 to about 0.77. Most of the improvement occurs early, followed by a plateau.\end{center}
\end{frame}
